        ...
        <div className="row m-0 privacy_policy_page">
            ...
            <div className="col-12 col-md-10">
                <div className=" my-0">
                    ...
                    <p>
                        We value the trust you place in us. That`s why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices.</p><p>
                        Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically.</p><p>
                        &nbsp;
                    </p>
                    <p>
                        <strong>Note:</strong>
                    ...
                    <ol className="p-0">
                        <li>
                            <strong> COLLECTION OF PERSONALLY IDENTIFIABLE INFORMATION AND OTHER INFORMATION</strong>
                        </li></ol><p>
                    ...
                    <p>
                        We also use the location to give you a better delivery services through the hyperlocal delivery
                    </p>
                    <p>
                    ...
                    <ol  className="p-0">
                        <li>
                            <strong> USE OF DEMOGRAPHIC / PROFILE DATA / YOUR INFORMATION</strong>
                        </li></ol><p>
                    ...
                    <ol  className="p-0">
                        ...
                        Our Website links to other websites that may collect personally identifiable information about you. Instadent.in is not responsible for the privacy practices or the content of those linked websites.
                    </p>
                    <ol  className="p-0">
                        <li>
                    ...
                    <p>
                        If you want to remove your contact information from all Instadent.in lists and newsletters, please visit to our customer support
                    </p>
                    <ol className="p-0">
                        <li>
                            <strong> ADVERTISEMENTS ON Instadent.in</strong>
                        </li></ol><p>
